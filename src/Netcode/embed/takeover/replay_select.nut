...
function Update()
{
	...
	if (this.cursor.ok && this.current_file)
	{
		...
		else if (::replay.Load(this.current_dir_name + this.current_file.name))
		{
			...
			{
				// [dec]
				// logger.open("D:\\Steam\\steamapps\\common\\th155\\logs\\" + this.current_dir_name + this.current_file.name + ".csv");
				logger.open("D:\\Steam\\steamapps\\common\\th155\\logs\\" + this.current_file.name + ".csv");
				logger.write("frame,p1_hp,p1_x,p1_y,p1_vx,p1_vy,p1_motion,p1_sp,p1_mp,p1_stun,p2_hp,p2_x,p2_y,p2_vx,p2_vy,p2_motion,p2_sp,p2_mp,p2_stun,hitbox_count,hitbox_data");
				// [dec]
				this.BeginVS();
			}
		}
